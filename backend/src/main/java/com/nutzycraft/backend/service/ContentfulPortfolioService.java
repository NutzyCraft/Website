...
public class ContentfulPortfolioService {
    ...
    public List<PortfolioItem> getPortfolioItems() {
        ...
        // For simplicity, let's assume we want all entries that have the required
        // fields or filter by contentType if known.
        // A safer bet if we don't know the exact ID but know the structure is just to
        // fetch entries and map them.
        // But usually content_type is required for specific queries.
        // Let's assume content type id is 'portfolio' as per instructions "entries of
        // type portfolio".
        ...
        try {
            ...
            // Fallback strategy: fetch all if "portfolio" content type might be named
            // differently or handle error
